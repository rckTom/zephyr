                                   ...
                                   enum sensor_channel channel)
{
    ...
    switch (channel) {
        case SENSOR_CHAN_GYRO_X:
            ...
            count = sizeof(&data->gyro_raw_values.x_value);
        break;
        case SENSOR_CHAN_GYRO_Y:
            start_reg = BMI088_REG_RATE_Y_LSB;
            data_start = &data->gyro_raw_values.y_value;
            count = sizeof(&data->gyro_raw_values.z_value);
        break;
        case SENSOR_CHAN_GYRO_Z:
        ...
        case SENSOR_CHAN_GYRO_XYZ:
            ...
            count = sizeof(data->gyro_raw_values.array);
        break;
        default:
        return -EINVAL;
    }
			   ...
			   const struct sensor_value *val)
{
    ...
    if (attr == SENSOR_ATTR_FULL_SCALE) {
        ...
        switch (val->val1) {   
            case 12:
                reg_val = BMI088_GYRO_BANDWITH_12;
            break;
            case 23:
                reg_val = BMI088_GYRO_BANDWITH_23;
            break;
            case 32:
                reg_val = BMI088_GYRO_BANDWITH_32;
            break;
            case 47:
                reg_val = BMI088_GYRO_BANDWITH_47;
            break;
            case 64:
                reg_val = BMI088_GYRO_BANDWITH_64;
            break;
            case 116:
                reg_val = BMI088_GYRO_BANDWITH_116;
            break;
            case 230:
                reg_val = BMI088_GYRO_BANDWITH_230;
            break;
            case 532:
...
static int bmi088_gyr_init(struct device *dev)
{
    ...
    data->gyro_odr =        BMI088_GYRO_DEFAULT_BANDWITH;
    ...
    /* Get chip id */
    res = data->tf->read_register(data, BMI088_REG_GYRO_CHIP_ID, 1, &chip_id);
    if (res != 0) { 
    ...
    u8_t reg_val = BMI088_GYRO_DEFAULT_BANDWITH;
